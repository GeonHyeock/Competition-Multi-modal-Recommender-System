...
def run_single_model(args):
    ...
    config = Config(
        model=NCL, dataset=args.dataset, config_file_list=args.config_file_list
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config", type=str, default="", help="External config file name."
    )
    args, _ = parser.parse_known_args()

    # Config files
    args.config_file_list = ["properties/overall.yaml", "properties/NCL.yaml"]
