...
def parse_args():
    ...
    parser.add_argument("--topks", nargs="?", default="[50]", help="@k test list")
    ...
    parser.add_argument(
        ...
        type=str,
        default="bspm-torch",
        help="simple-rec-model, support [none, lgn-ide, gf-cf, bspm]",
    )

    parser.add_argument("--adjoint", type=eval, default=False, choices=[True, False])
    parser.add_argument(
        "--solver_idl", type=str, default="euler", help="heat equation solver"
    )
    parser.add_argument(
        "--solver_blr", type=str, default="euler", help="ideal low-pass solver"
    )
    parser.add_argument(
        "--solver_shr", type=str, default="rk4", help="sharpening solver"
    )
    ...
    parser.add_argument("--K_s", type=int, default=2, help="T_s / \tau")
    parser.add_argument("--T_s", type=float, default=2.2, help="T_s")
    ...
    parser.add_argument(
        "--final_sharpening", type=eval, default=False, choices=[True, False]
    )
    parser.add_argument(
        "--sharpening_off", type=eval, default=False, choices=[True, False]
    )
    parser.add_argument(
        "--t_point_combination", type=eval, default=False, choices=[True, False]
    )
